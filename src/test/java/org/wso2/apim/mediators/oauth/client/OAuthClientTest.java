...
public class OAuthClientTest {
    ...
    public void init(){
        ...
        try {
            actual = ConfigReader.readConfiguration(absolutePath);
    ...
    public void testGenerateToken() throws IOException {
        ...
        OAuthEndpoint endpoint=actual.get(1);
        final TokenResponse tokenResponse = OAuthClient.generateToken(endpoint.getTokenApiUrl(), endpoint.getApiKey(), endpoint.getApiSecret(),
